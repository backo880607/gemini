...
EntityObject::SPtr BaseController::getInheritImpl(const Class &cls, Long id) const
{
...
EntityObject::SPtr BaseController::getImpl(EntityObject::SPtr entity, const std::vector<Int> &signs) const
{
	return IocRelation::get(entity, signs);
}

const IList &BaseController::getListImpl(EntityObject::SPtr entity, const std::vector<Int> &signs) const
{
	return IocRelation::getList(entity, signs);
}

void BaseController::setImpl(EntityObject::SPtr entity, Int sign, EntityObject::SPtr relaEntity) const
{
