...
class IDGenerator final {
  IDGenerator() : m_lastMilliseconds(0), _logicSlice(0), _seq_id(0) {
...
Boolean EntityObject::operator==(const Any& rhs) const { return Boolean(); }
...
const EntityObject::SPtr& IList::Iterator::nextImpl() { return nullptr; }
