...
Any MathFunction::funPow(const std::vector<Any>& params) {
  Double value1 = params[0].isType<Long>() ? params[0].cast<Long>()
                                           : params[0].cast<Double>();
  Double value2 = params[1].isType<Long>() ? params[1].cast<Long>()
                                           : params[1].cast<Double>();
...
Any MathFunction::funRandom(const std::vector<Any>& params) { return rand(); }
