...
template <int args_size __REPEAT(N, __TEMPLATE_ARG__, __COMMA__, __COMMA__, __NOTHING__)> struct __callable_args##N##__ : public __callable__ {\
    ...
    const Class& get_ret_type() const { return ret_type; }\
}
...
struct CORE_API __register_method__ {
	__register_method__(__callable__ *cb, const Class *pclass, const char *type, const char *name, const char *args, const char *virt);
};
...
public:
	...
	static UInt max_limits();
	static UInt maxIndex() { return s_maxIndex; }
	UInt index() const { return _index; }
	const String& getName() const { return _name; }
	...
	template <>
	static const Class& forType<UChar>() { static const Class _class("UChar", nullptr, create<UChar>); return _class; }
	template <>
	static const Class& forType<WChar>() { static const Class _class("WChar", nullptr, create<WChar>); return _class; }
	template <>
	static const Class& forType<Short>() { static const Class _class("Short", nullptr, create<Short>); return _class; }
	template <>
	static const Class& forType<UShort>() { static const Class _class("UShort", nullptr, create<UShort>); return _class; }
	template <>
	static const Class& forType<Int>() { static const Class _class("Int", nullptr, create<Int>); return _class; }
	template <>
	static const Class& forType<UInt>() { static const Class _class("UInt", nullptr, create<UInt>); return _class; }
	template <>
	static const Class& forType<Long>() { static const Class _class("Long", nullptr, create<Long>); return _class; }
	template <>
	static const Class& forType<ULong>() { static const Class _class("ULong", nullptr, create<ULong>); return _class; }
	template <>
	...
	template <>
	static const Class& forType<LDouble>() { static const Class _class("LDouble", nullptr, create<LDouble>); return _class; }
	template <>
...
CORE_API SmartPtr<EntityObject> afxGetRelation(SmartPtr<EntityObject> entity, UInt sign);
CORE_API void afxSetRelation(SmartPtr<EntityObject> entity, UInt sign, SmartPtr<EntityObject> relaEntity);
...
protected:
	...
	const_reference get(const EntityObject* entity, UInt sign) {
...
protected:
	...
	const_reference get(EntityObject* entity, UInt sign) {
		SmartPtr<EntityObject> entitySPtr;
		entitySPtr.wrapRawPointer(entity);
		return afxGetRelation(entitySPtr, sign);
	}

	void set(EntityObject* entity, UInt sign, const_reference val) {
		SmartPtr<EntityObject> entitySPtr;
		entitySPtr.wrapRawPointer(entity);
...
template <class T> UInt Sign<T>::index = 0;
...
public:\
	class MODULE_API FIELD_NAME : public gemini::PropertyRef<CLASS_NAME, gemini::RefType::Entity>  {\
	...
	public:\
		...
		static gemini::UInt index() { static const gemini::UInt temp = ClassType::s_index++; return temp; }\
	private:\
...
public:\
	class MODULE_API FIELD_NAME : public gemini::PropertyRef<CLASS_NAME, gemini::RefType::Vector>  {\
...
private:\
    struct REF_JOIN(__method_##METHOD_NAME##__,LINE) {\
        REF_JOIN(__method_##METHOD_NAME##__,LINE) () {\
            ...
            static gemini::__register_method__ reg(__create_callable__(method_ptr), &gemini::Class::forType<gemini::Boolean>(), #RETURN_TYPE, #METHOD_NAME, #METHOD_ARGS, #VIRTUAL);\
        }\
    } REF_JOIN(__method_##METHOD_NAME##__,LINE);\
