...
class CORE_API Field final
{
  ...
  public:
	...
	template <class Value>
	Value get(const SmartPtr<EntityObject> &object) const { return get<Value>(object.rawPointer()); }
	template <class Value>
	void set(SmartPtr<EntityObject> &object, const Value &value) const { return set<Value>(object.rawPointer(), value); }
...
class CORE_API EnumHelper
{
  ...
  public:
	...
	const Class &getClass() const { return _class; }
	Int getValue(const String &value) const;
  ...
  public:                                                                                                                                                     \
	...
	{                                                                                                                                                         \
	  ...
	  public:                                                                                                                                                 \
		...
		{                                                                                                                                                     \
			static const gemini::Field *holder = &getClassStatic().getField(#FIELD_NAME);                                                                     \
			return holder;                                                                                                                                    \
		}                                                                                                                                                     \
	} _##FIELD_NAME;                                                                                                                                          \
...
#define DEFINE_ENUM_IMPL(enum_type) \
	const gemini::EnumHelper::Register<enum_type> geminiAfxEnum##enum_type(gemini_enum_##enum_type);
